...
export function EngineeringPhilosophy(): ReactElement {
  return (
    <Section className="section-blend bg-surface-brand/40 dark:bg-surface-brand/35">
      <Container>
        <AnimatedSection className="flex flex-col gap-8">
          ...
          <div className="flex max-w-2xl flex-col gap-6">
            ...
            <Text className="text-ink-2" size="md">
              ...
              technically sound, but also manufacturable, safe, maintainable,
              and reproducible. Standards and procedures are not bureaucracy:
              they are accumulated knowledge about how solutions fail in the
              real world. Meeting them is the work.
            </Text>
          </div>
